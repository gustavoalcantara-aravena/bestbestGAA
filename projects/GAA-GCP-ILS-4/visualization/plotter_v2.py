...
class PlotManagerV2:
    ...
    def plot_family_scalability_time(self,
        ...
        try:
            ...
            filepath = family_dir / f"01_scalability_time_({family_name}).png"
            plt.savefig(filepath, dpi=300, bbox_inches='tight')
            plt.close()
    ...
    def plot_family_scalability_quality(self,
        ...
        try:
            ...
            filepath = family_dir / f"02_scalability_quality_gap_({family_name}).png"
            plt.savefig(filepath, dpi=300, bbox_inches='tight')
            plt.close()
    ...
    def plot_family_robustness_boxplot(self,
        ...
        try:
            ...
            filepath = family_dir / f"03_robustness_color_distribution_({family_name}).png"
            plt.savefig(filepath, dpi=300, bbox_inches='tight')
            plt.close()
    ...
    def plot_family_algorithm_ranking(self,
        ...
        try:
            ...
            filepath = family_dir / f"04_average_ranking_({family_name}).png"
            plt.savefig(filepath, dpi=300, bbox_inches='tight')
            plt.close()
